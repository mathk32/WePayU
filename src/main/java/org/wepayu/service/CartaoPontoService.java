...
public class CartaoPontoService {
    ...
    public Integer entrada(LocalTime horario_entrada, Integer id, LocalDate dia){
        entity.getTransaction().begin();
        Empregado empregado_encontrado = entity_empregado.find(Empregado.class, id);
        Cartao_ponto cartao = new Cartao_ponto(horario_entrada,null, empregado_encontrado,dia);
